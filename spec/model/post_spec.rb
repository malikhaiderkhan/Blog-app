...
RSpec.describe Post, type: :model do
    ...
    it 'comments_count should be non negative integer' do
        ...
        subject.comments_count = 5
        expect(subject).to be_valid

        subject.comments_count = 'abc'
        expect(subject).to_not be_valid
    end

    it 'likes_count should be non negative integer' do
        ...
        subject.likes_count = 5
        expect(subject).to be_valid

        subject.likes_count = 'abc'
        expect(subject).to_not be_valid
    end
    ...
    it 'should update posts counter' do
        ...
        expect(subject.posts_count).to eq(2)
    end
